		...
		<?=form_open('') ?>
			...
			<div class="form-group">
			  ...
			  <?=form_input(array(
					...
					'value' => set_value('education_condition', ((empty($regHusband)) ? '' : $regHusband->education_condition)),
					'class'=> 'form-control',
				)) ?>
			</div>
			...
			<div class="form-group">
			  ...
			  <?=form_input(array(
					...
					'id' => 'age_in_marriage',
					'value' => set_value('age_in_marriage', ((empty($regHusband)) ? '' : $regHusband->age_in_marriage)),
					'class'=> 'form-control',
				)) ?>
			</div>
