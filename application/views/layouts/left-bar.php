...
<div class="nav-side-menu navbar-inverse bg-inverse">
    ...
    <div class="menu-list">
        <ul id="menu-content" class="menu-content collapse out">
			...
			<?php if($loggedInUserType == 'superadmin' || $loggedInUserType == 'admin' || $loggedInUserType == 'midwife') { ?>
            ...
            <ul class="sub-menu collapse <?=(isset($menu) && $menu=='dicisions')?'show':''?>" id="dicisions">
				<?php if($loggedInUserType == 'superadmin' || $loggedInUserType == 'admin') { ?>
				...
				<?php } else if($loggedInUserType == 'moh') { ?>
					<li <?=(isset($submenu) && $submenu=='dicisions-get_risk_to_weight_children') ? 'class="active"':''; ?>><a href="/dicision/get_risk_to_weight_children">Children who have Risk For Malnutrition ?</a></li>
					<li <?=(isset($submenu) && $submenu=='dicisions-get_malnutrition_children') ? 'class="active"':''; ?>><a href="/dicision/get_malnutrition_children">Children who have Malnutrition ?</a></li>
			...
			<?php if($loggedInUserType != 'principal') { ?>
            ...
            <ul class="sub-menu collapse <?=(isset($menu) && $menu=='charts')?'show':''?>" id="charts">
				<?php if($loggedInUserType == 'superadmin' || $loggedInUserType == 'admin') { ?>
					...
					<li <?=(isset($submenu) && $submenu=='charts-income_chart_view') ? 'class="active"':''; ?>><a href="/Chart/income_chart_view">Population based on the Income?</a></li>
					<li <?=(isset($submenu) && $submenu=='charts-age_chart_view') ? 'class="active"':''; ?>><a href="/Chart/age_chart_view">Population based on the Age?</a></li>
			...
			<?php if($loggedInUserType == 'superadmin') { ?>
